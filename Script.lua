    ...
    if _G.SilentAimEnabled and CachedTarget and CachedPredPos then
        if Method == "FireServer" or Method == "InvokeServer" then
            for i, arg in pairs(Args) do
                ...
                elseif typeof(arg) == "Instance" and arg:IsA("BasePart") then Args[i] = GetAimPart(CachedTarget.Character) end
            end
...
OldIndex = hookmetamethod(game, "__index", function(self, Index)
    if self == Mouse and _G.SilentAimEnabled and CachedTarget and CachedPredPos then
        ...
        elseif Index == "Target" then return GetAimPart(CachedTarget.Character) end
    end
...
RunService:BindToRenderStep("LowHighMedioAim", Enum.RenderPriority.Camera.Value + 1, function()
