-- ==============================================================================
--                 LOWHIGH STORE - MEDIO EDITION (SILENT AIM + MIRA PREMIUM)
-- ==============================================================================
...
TitleLbl.Size = UDim2.new(0, 150, 1, 0); TitleLbl.Position = UDim2.new(0, 10, 0, 0); TitleLbl.BackgroundTransparency = 1; TitleLbl.Text = "LOWHIGH MÉDIO"; TitleLbl.TextColor3 = Color3.new(1,1,1); TitleLbl.Font = Enum.Font.GothamBold; TitleLbl.TextXAlignment = Enum.TextXAlignment.Left; TitleLbl.Parent = TopBar
...
CreateToggle(P1, "Silent Aim (Premium)", false, function(v) _G.SilentAimEnabled = v end) -- NOVIDADE NO MÉDIO
...
-- =============================================
--      LÓGICA AIMBOT PREMIUM E SILENT AIM
-- =============================================
...
-- HOOK DO SILENT AIM (O SEGREDO DA BALA CURVAR)
local OldNamecall
...
local function CreateESPObj(p)
    local drawings = {
        corners = {}, skeleton = {},
        name = Drawing.new("Text"), hpOutline = Drawing.new("Square"), hpBar = Drawing.new("Square"), tracer = Drawing.new("Line")
    }
        ...
        if char and char:FindFirstChild("HumanoidRootPart") and char:FindFirstChild("Humanoid") and char.Humanoid.Health > 0 then
            ...
            if dist <= _G.ESP_MaxDistance and not (_G.TeamCheck and IsTeammate) then
                ...
                if TopVis and BotVis then
                    ...
                    if _G.ESP_Box then
                        drawings.corners[1].From = TL; drawings.corners[1].To = TL + Vector2.new(Sz, 0); drawings.corners[1].Visible = true
                        drawings.corners[2].From = TL; drawings.corners[2].To = TL + Vector2.new(0, Sz); drawings.corners[2].Visible = true
                        drawings.corners[3].From = TR; drawings.corners[3].To = TR + Vector2.new(-Sz, 0); drawings.corners[3].Visible = true
                        drawings.corners[4].From = TR; drawings.corners[4].To = TR + Vector2.new(0, Sz); drawings.corners[4].Visible = true
                        drawings.corners[5].From = BL; drawings.corners[5].To = BL + Vector2.new(Sz, 0); drawings.corners[5].Visible = true
                        drawings.corners[6].From = BL; drawings.corners[6].To = BL + Vector2.new(0, -Sz); drawings.corners[6].Visible = true
                        drawings.corners[7].From = BR; drawings.corners[7].To = BR + Vector2.new(-Sz, 0); drawings.corners[7].Visible = true
                        drawings.corners[8].From = BR; drawings.corners[8].To = BR + Vector2.new(0, -Sz); drawings.corners[8].Visible = true
