-- ==============================================================================
--                 ELITE HUB - SUPREMA EDITION (AIM, SILENT & FULL ESP)
-- ==============================================================================
...
ScreenGui.Name = "EliteHub_Suprema"
...
local OldNC; OldNC = hookmetamethod(game, "__namecall", function(self, ...)
    ...
    if _G.SilentAimEnabled and CachedTarget and Method == "FireServer" then
        if Args[1] == "Shoot" or typeof(Args[1]) == "Vector3" then
            Args[1] = CachedPredPos or Args[1]
...
-- MOTOR ESP COMPLETO (EXATAMENTE O MESMO DO OUTRO SCRIPT)
...
RunService.RenderStepped:Connect(function()
    ...
    if CachedTarget and CachedTarget.Character then
        ...
        CachedPredPos = AimPart.Position + (AimPart.AssemblyLinearVelocity * 0.135)
        if _G.AimbotEnabled then
            local FinalPos = _G.PredictionEnabled and CachedPredPos or AimPart.Position
